 ...
 * <p/>
 * For example, {@link EvaluationContextExtension}s that want to contribute properties based on contextual values to be
 * evaluated during repository query method execution.
 * <p/>
...
public interface SubscriberContextAware<T> extends Aware {
	 ...
	 * @return a new {@link EvaluationContextExtension} instance that is only valid during the lifespan of the enclosing
	 *         subscription.
	 */
